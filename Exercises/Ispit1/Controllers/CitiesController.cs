...
namespace Ispit1.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult AddCity(int id) {
            var model = new AddListingToCityModel();
            model.CityId = id;
            model.listings = db.listings.ToList();
        ...
        [HttpPost]
        public ActionResult AddCity(AddListingToCityModel model) {
            var city = db.cities.Find(model.CityId);
            var listing = db.listings.Find(model.listingId);
            city.apartments.Add(listing);
            db.SaveChanges();
            return View("Index", db.cities.ToList());
        }
